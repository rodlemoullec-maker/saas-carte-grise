    ...
    def build_data_from_dossier(dossier: dict) -> dict:
        ...
        for doc in docs:
            ...
            if dtype == "COC":
                ...
                d["vehicule"]["masse_f3"] = ext.get("masse_f3", "")
                d["vehicule"]["poids_vide_g1"] = ext.get("poids_vide_g1", "")
                ...
                d["vehicule"]["niveau_sonore_u1"] = ext.get("niveau_sonore_u1", "")
                d["vehicule"]["vitesse_moteur_u2"] = ext.get("vitesse_moteur_u2", "")
                d["vehicule"]["places_debout_s2"] = ext.get("places_debout_s2", "")
